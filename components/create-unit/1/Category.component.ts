...
export class CategoryComponent extends BaseComponent {
	...
	constructor(page: Page) {
		...
		this.popupTitle = this.popup.locator(
			`text=${
				isDesktop(this.page) ? tabs.mainInfo.category.popupTitle : tabs.mainInfo.category.mobilePopupTitle
			}`,
		);
		...
		this.firstCategory = this.page.getByTestId("firstCategoryWrapper").first();
