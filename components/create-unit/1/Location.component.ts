...
export class LocationComponent extends BaseComponent {
	...
	constructor(page: Page) {
		...
		this.errorBlock = this.section.getByText(FIELDS_ERRORS.MISSING_LOCATION);
		this.modalWindow = this.page.getByTestId("mapPopup");
		this.modalWindowTitle = this.modalWindow.getByText(tabs.mainInfo.location.modal.title);
