...
export class PhotosComponent {
	...
	constructor(readonly page: Page) {
		...
		this.photosFormDescription = this.page.getByTestId("ImagesUnitFlow").getByTestId("description");
		this.uploadPhotoButtonsWrapper = this.page.getByTestId("imageBlock").locator("..");
		this.uploadPhotoButtons = this.uploadPhotoButtonsWrapper.getByTestId("imageBlock");
		this.uploadedPhotoButtons = this.uploadPhotoButtonsWrapper.locator("[draggable='true']");
		this.placeholderButtons = this.uploadPhotoButtonsWrapper.locator("[draggable='false']");
		this.fileInput = this.page.locator('input[type="file"]');
		this.requiredSymbol = this.photosFormTitle.locator("span");
		this.errorModalText = this.page.getByTestId("errorPopup");
		this.errorModalOKButton = this.errorModalText.locator("..").getByRole("button");
		this.closeModalIcon = this.errorModalText.locator("../..").getByTestId("closeIcon");
	}
	...
	async removePhotos(count: number | null = null) {
		const imagesForRemoving = count ?? (await this.uploadedPhotoButtons.count());
