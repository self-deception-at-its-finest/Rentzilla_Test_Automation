...
export class AuthenticationComponent {
	...
	constructor(readonly page: Page) {
		...
		// Admin version
		// because of ugly front-end code
		this.adminAuthContainer = this.page.getByTestId("authorizationContainer").nth(1);
		this.adminAuthTitle = this.adminAuthContainer.getByTestId("authorizationTitle");
		this.adminAuthCloseButton = this.adminAuthContainer.getByTestId("authClose");
		this.adminEmailInput = this.adminAuthContainer.locator("input#email");
		this.adminPasswordInput = this.adminAuthContainer.locator("input#password");
